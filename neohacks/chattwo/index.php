...
<body>
    <div class="container">
        <div class="info">
            ...
            <br>
            <a href="../chat/index.php" style="border-radius: 5px; padding: 5px; background-color: white; border: 1px solid gray; width: auto; text-decoration:none; color: black;">Chill Chat</a>
            <br>
